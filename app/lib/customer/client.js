...
export const addressesClient = async (context, {customerAccessToken}) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
    const get = {
...
export const addressCreateClient = async (
  context,
  {customerAccessToken, address, isDefault},
) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
...
export const addressUpdateClient = async (
  context,
  {customerAccessToken, id, address, isDefault},
) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
...
export const customerActivateClient = async (
  context,
  {customerId, activationToken, password},
) => {
  let errors = [];
  try {
    const {storefront} = context;
...
export const customerGetClient = async (context, {customerAccessToken}) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
    const get = {
...
export const customerMetafieldClient = async (
  context,
  {customerAccessToken, key, namespace},
) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
...
export const customerLoginClient = async (context, {email, password}) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
    let errors = [];
...
export const customerOrdersClient = async (
  context,
  {customerAccessToken, first, last, before, after = ''},
) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
...
export const passwordResetClient = async (context, {password, url}) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
    const reset = {
...
export const passwordRecoverClient = async (context, {email}) => {
  try {
    const {storefront} = context;
    const {country, language} = storefront.i18n;
    const recover = {
